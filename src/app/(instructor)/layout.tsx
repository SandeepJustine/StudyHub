...
const instructorMenuItems = [
  ...
  { label: 'Virtual Lab', href: '/instructor/lab', icon: <FlaskConical size={20} /> },
...
export default async function InstructorLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <DashboardShell role="INSTRUCTOR" title="Instructor Dashboard" description="Manage your courses and earnings" menuItems={instructorMenuItems}>
      {children}
    </DashboardShell>
  );
}