...
export default function InstructorThreadPage() {
  ...
  if (error || !thread) {
    return (
      <div className="p-6 max-w-4xl">
        <Link href="/instructor/community" className="text-grey-medium hover:text-navy flex items-center gap-1 text-sm mb-4">
  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl">
      {/* Back Navigation */}
      <Link href={thread.forum ? `/instructor/community` : '/instructor/community'} 
