...
import { LayoutDashboard, Users, GraduationCap, BookOpen, BarChart3, Palette, Upload, Settings, Award, FileText } from 'lucide-react';
...
const menu = [
  ...
  { label: 'Certificates', href: '/school-admin/certificates', icon: <Award size={20} /> },
  { label: 'Templates', href: '/school-admin/certificates/templates', icon: <FileText size={20} /> },
